...
class InventoryEndpointState(Base):
    ...
    inventory_snapshot_id: Mapped[str | None] = mapped_column(String(255))
    session_snapshot_id: Mapped[str | None] = mapped_column(String(255))
    ...
    inventory_semantic_hash: Mapped[str | None] = mapped_column(String(64))
    session_semantic_hash: Mapped[str | None] = mapped_column(String(64))
