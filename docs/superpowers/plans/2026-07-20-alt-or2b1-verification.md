...
- Временные Actions workflows и patch helpers должны быть удалены до Ready for
  review.

## Изменения после проверенного source SHA

После `c567393625cb930e82a5cf1d7f0374f22b941ac3` изменялись только документация
и временная CI-инфраструктура для исправления имени legacy test module.
Production Python и executable tests не изменялись.
