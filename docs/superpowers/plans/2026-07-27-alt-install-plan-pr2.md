...
- [x] **Step 1: Write failing parser and boundary tests**
...
- [x] **Step 3: Implement frozen inventory types and exact validation**
...
- [x] **Step 4: Verify the focused parser suite**

Run: python -m pytest -q tests/alt_linux/test_install_inventory.py

Expected: PASS, including stable hash equality after parse/serialise/parse.

- [x] **Step 5: Commit the inventory boundary**
...
- [x] **Step 3: Implement data-only profile and policy evaluation**
...
- [x] **Step 4: Verify policy results**

Run: python -m pytest -q tests/alt_linux/test_install_policy.py

Expected: PASS for all accepted and rejected fixtures.

- [x] **Step 5: Commit policy and fixtures**
...
- [x] **Step 3: Implement fingerprint and builder**
...
- [x] **Step 1: Write failing deterministic renderer tests**
...
- [x] **Step 3: Implement constrained rendering**
...
- [x] **Step 4: Verify renderer output**
...
- [x] **Step 2: Verify the ALT domain suite fails until complete**
...
- [x] **Step 4: Run focused and full regression**
...
- [x] **Step 2: Re-run final evidence**
...
- [x] **Step 3: Mark completed work and commit plan state**
