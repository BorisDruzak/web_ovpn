...
LLDP_REM_CHASSIS_ID_SUBTYPE = numeric_oid("1.0.8802.1.1.2.1.4.1.1.4")
LLDP_REM_CHASSIS_ID = numeric_oid("1.0.8802.1.1.2.1.4.1.1.5")
LLDP_REM_PORT_ID_SUBTYPE = numeric_oid("1.0.8802.1.1.2.1.4.1.1.6")
LLDP_REM_PORT_ID = numeric_oid("1.0.8802.1.1.2.1.4.1.1.7")
LLDP_REM_PORT_DESC = numeric_oid("1.0.8802.1.1.2.1.4.1.1.8")
LLDP_REM_SYS_NAME = numeric_oid("1.0.8802.1.1.2.1.4.1.1.9")
LLDP_REM_SYS_DESC = numeric_oid("1.0.8802.1.1.2.1.4.1.1.10")
LLDP_REM_SYS_CAP_SUPPORTED = numeric_oid("1.0.8802.1.1.2.1.4.1.1.11")
LLDP_REM_SYS_CAP_ENABLED = numeric_oid("1.0.8802.1.1.2.1.4.1.1.12")
LLDP_REM_MAN_ADDR_IF_SUBTYPE = numeric_oid("1.0.8802.1.1.2.1.4.2.1.3")
